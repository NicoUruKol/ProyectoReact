    ...
    return(
        <section className="nosotros-4">
            <div className="cont-img-triptico-nosotros">
                <img src="/cocechador-600x400 tannat.jpg" alt="" className="img-triptico-nosotros"/>
            </div>
            ...
            <div className="cont-img-triptico-nosotros">
                <img src="/tannat-medalla-600x400 tannat.jpg" alt="" className="img-triptico-nosotros"/>
            </div>
            <div className="cont-p-triptico-nosotros">
                <p>
            ...
            <div className="cont-img-triptico-nosotros">
                <img src="/las-bodegas-600x400 tannat.jpg" alt="" className="img-triptico-nosotros"/>
            </div>
            <div className="cont-p-triptico-nosotros">
                <p>
